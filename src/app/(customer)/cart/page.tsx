                      ...
                      <div className="flex flex-col justify-between flex-grow">
                        <div>
                          <div className="flex justify-between items-start mb-2">
                            <h3 className="font-display font-semibold text-lg text-on-surface">{language === "en" ? details.nameEn : item.title}</h3>
                            <button
                          ...
                          <div className="flex flex-wrap gap-1.5 mb-3">
                            {(language === "en" ? details.tagsEn : details.tags).map((tag) => (
            ...
            <div className="bg-surface-container-lowest rounded-2xl p-6 shadow-[0px_10px_40px_rgba(0,0,0,0.06)] border border-outline-variant/10 sticky top-28 flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex justify-between font-sans text-sm text-on-surface-variant">
                  ...
                  <span className="text-on-surface-variant font-semibold">{formatCOP(deliveryFee)}</span>
                </div>
